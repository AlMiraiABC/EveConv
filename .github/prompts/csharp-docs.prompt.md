---
agent: 'agent'
tools: ['read/problems', 'read/readFile', 'edit/createFile', 'edit/editFiles', 'search/changes', 'search/codebase']
description: 'Ensure that C# types are documented with XML comments and follow best practices for documentation.'
---
<!-- https://github.com/github/awesome-copilot/blob/e0dd4e62aa1c91cb416e2b4522c0b37cb060241e/prompts/csharp-docs.prompt.md -->
...
## README file
- Create or update the `README.md` file in each folder(include project folder and solution folder) to explain the purpose of the folder and any important details about its contents.

...
namespace EveConv.Cache.Redis
{
    ...
    {
        public async Task<object?> GetByIndexAsync(string key, int index)
        {
            ThrowIfDisposed();
            ValidateKey(key);
        ...
        public async Task<int> GetLengthAsync(string key)
        {
            ThrowIfDisposed();
            ValidateKey(key);
        ...
        public async Task<IList<object>> GetRangeAsync(string key, int start = 0, int stop = -1)
        {
            ThrowIfDisposed();
            ValidateKey(key);
        ...
        public async Task<IList<object>> LeftPopAsync(string key, int count)
        {
            ThrowIfDisposed();
            ValidateKey(key);
        ...
        public async Task<int> LeftPushAsync(string key, IEnumerable<object> values, TimeSpan? ttl = null)
        {
            ThrowIfDisposed();
            ValidateKey(key);
            ...
            if (valueList.Count == 0)
            {
                ...
                return await GetLengthAsync(key);
            }
        ...
        public async Task<int> RemoveAsync(string key, object value, int count = 0)
        {
            ThrowIfDisposed();
            ValidateKey(key);
        ...
        public async Task<IList<object>> RightPopAsync(string key, int count)
        {
            ThrowIfDisposed();
            ValidateKey(key);
        ...
        public async Task<int> RightPushAsync(string key, IEnumerable<object> values, TimeSpan? ttl = null)
        {
            ThrowIfDisposed();
            ValidateKey(key);
            ArgumentNullException.ThrowIfNull(values);
        ...
        public async Task<bool> SetByIndexAsync(string key, int index, object value)
        {
            ThrowIfDisposed();
            ValidateKey(key);
        ...
        public async Task TrimAsync(string key, int start, int stop)
        {
            ThrowIfDisposed();
            ValidateKey(key);
